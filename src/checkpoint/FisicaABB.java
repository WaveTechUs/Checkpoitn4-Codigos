...
public class FisicaABB {
		Scanner sc = new Scanner(System.in);
		public Cliente cliente;
		public FisicaABB esq;	
		public FisicaABB dir;
		public FisicaABB raiz = null;
		...
		public FisicaABB inserir(FisicaABB a, Cliente c) {
		...
		public void mostraCliente(FisicaABB a, double minSaldo) {
			if(a != null) {
		...
		public void consultaCliente(FisicaABB a, String cpf) {
		    if (a != null) {
		...
		public void atualizaSaldo(int numConta) {
			FisicaABB clienteABB = atualizaSaldo(raiz, numConta);
		...
		public FisicaABB atualizaSaldo(FisicaABB a, int numConta) {
		    if (a != null) {
		...
		public int QtdClientes(FisicaABB a, int qtd) {
			if(a != null) {
		...
		public int QtdClientesSaldo(FisicaABB a, int qtd, double saldo) {
			if(a != null) {
